 ...
 *
 * <p>The WebP container stores loop count as the number of animation repetitions.
 * A value of {@code 0} means that the animation repeats forever. The library exposes
...
public final class LoopCount {
     ...
     * @throws IllegalArgumentException if {@code repetitions <= 0}
     */
     ...
     *
     * @return {@code true} if the loop count is infinite
     */
     ...
     *
     * <p>This method is only valid for finite loop counts.
     *
